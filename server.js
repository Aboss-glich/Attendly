  ...
  try {
    if (!fs.existsSync(USERS_FILE)) {
      const demoOwner = {
        ...
        role: 'owner',
        name: 'Owner',
        passwordHash: 'ce71018269e919c089ecb542bbac279e21338fcb14237637c06e966be4375a42bebb9b1ed53426bbec5217811f7d004a35d02f65f20506463a45ba1337bd8e17',
        salt: 'AttendlyDemoSalt2026'
      };
      fs.writeFileSync(USERS_FILE, JSON.stringify([demoOwner], null, 2));
    }
    return JSON.parse(fs.readFileSync(USERS_FILE, 'utf8'));
  } catch (e) {
    console.error('Unable to load users:', e.message);
    return [];
  }
}
